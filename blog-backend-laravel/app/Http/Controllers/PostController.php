...
class PostController extends Controller
{
    ...
    public function show($id){
        $posts = Post::find($id)->load('category')->load('user');
    ...
    public function store(Request $request){
        ...
        if($validate->fails()){
            $data = [
                'code' => 400,
                'status' => 'error',
                'mensaje' => 'No se a guardado el post, faltan datos',
           ];
    ...
    public function update($id, Request $request){
        ...
        //buscar el registro en cocnreto
        ...
        if(!empty($post && is_object($post))){
            ...
            //actualizar registros en concreto
    ...
    public function upload(Request $request){
        //recoger la imagen de lapeticion
        ...
        //guardar la imagen en el disco imagen
